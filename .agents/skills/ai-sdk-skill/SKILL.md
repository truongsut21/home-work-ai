...
You can access the entire AI SDK documentation in Markdown format at docs/ai-sdk-core/llms.txt. This can be used to ask any LLM (assuming it has a big enough context window) questions about the AI SDK based on the most up-to-date documentation.

### Example Usage

For instance, to prompt an LLM with questions about the AI SDK:

1. Copy the documentation contents from docs/ai-sdk-core/llms.txt
